...
{ 
  ...
  // 1.5T = 1.14583ms * 1.5 = 1.71875ms. A frame delay is 3.5T.
	...
	// inter frame delay should be 3.5 * T	
	// This is especially crucial in the DUE as it tends to
	// truncate the message before transmission ends.
	// allowing 2 character time outs should suffice before pulling the 
	// TxRxEnable pin low
	frameDelay = T1_5 * 2; 
